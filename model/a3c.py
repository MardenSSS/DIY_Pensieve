...
class A3C:
    def __init__(self,
        ...
        self.actor = ActorNet(n_feature=self.n_feature, n_action=self.n_action).to(self.device)
        if self.is_central:
            ...
            self.critic = CriticNet(n_feature=self.n_feature, n_action=self.n_action).to(self.device)
